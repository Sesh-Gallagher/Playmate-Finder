/**
 * Renders a card component that displays recent activity items.
 * Each activity item includes an icon, message, and timestamp.
 * The activity items are displayed in a vertical layout with spacing.
 */
